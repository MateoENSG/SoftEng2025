...
class Building {
	public:
		// ! \\ Creates a Building with identifier and a number of rocks in its collection
		...
		const Rock* get_rock(unsigned int index) const; //const here so that this fction is only an accessor, it won't modify the other objects.
